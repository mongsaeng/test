...
function createCalendar(calendar, element, adjuster){
  ...
  function AddDateTime(){
    ...
    var YearVal = document.createElement('span'); 
    today.className += ' today';
    YearVal.innerHTML = calendar.Selected.Year;
    today.innerHTML = months[calendar.Selected.Month] + " ";
    today.append(YearVal);
    ...
    for(var i = 0; i < calendar.Selected.Days; i++){
      ...
      for(var n = 0; n < calendar.Model.length; n++){
        ...
        if(evDate.getTime() > toDate.getTime()){
          number.className += " seat lateFee";
        }
        if(evDate.getTime() < toDate.getTime()){
          number.className += " noSeat";
        }
        console.log(evDate, "-----------", toDate)
        if(evDate.getTime() == toDate.getTime()){
          number.className += " selDate";
